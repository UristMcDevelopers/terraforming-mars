[//]: # (Is a direct copy of tiger style with few additions)
# On copying tiger style
## Why not write your own conduct?
Because despite the differences in languages, it provides very good rules for writing code.
## Why not write your own style for lua language?
Because even if defold mainly uses lua scripts, you can use whatever you want (even zig) with the right extensions.
# Tiger Style
...
We have a “zero technical debt” policy. We do it right the first time. This
